  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 8
      h1  La satisfacción del cliente: elementos y reto

    .row.align-items-center.mb-4 
      .col-lg-7
        h4 La satisfacción del cliente
        ...
        p.mb-4 En la actualidad, los usuarios cuentan con diversas entidades (EPS), permitiéndole escoger cuál de ellas es la mejor para su bienestar. Ahora bien, si obtiene una experiencia de atención satisfactoria esto permitirá que aumente el número de usuarios y que mejore la calidad de atención en la EPS.
        p.mb-0 <b>Cómo lograr la satisfacción del cliente. (Larraín, 2012). Se deben tener en cuenta las siguientes recomendaciones:</b>
      .col-lg-5
        figure
    ...
    .row.align-items-center
      .col-lg-4
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/1.svg', alt='Texto que describa la imagen')
          .col-lg-9
        ...
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/2.svg', alt='Texto que describa la imagen')
          .col-lg-9
        ...
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/3.svg', alt='Texto que describa la imagen')
          .col-lg-9
        ...
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/4.svg', alt='Texto que describa la imagen')
          .col-lg-9
        ...
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/6.svg', alt='Texto que describa la imagen')
          .col-lg-9
      ...
      .col-lg-4
        figure
          img(src='@/assets/curso/tema8/img2.png', alt='Texto que describa la imagen')
      .col-lg-4
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/7.svg', alt='Texto que describa la imagen')
          .col-lg-9
        ...
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/8.svg', alt='Texto que describa la imagen')
          .col-lg-9
        ...
        .row.align-items-center.mb-4
          .col-lg-3
            figure
              img(src='@/assets/curso/tema8/12.svg', alt='Texto que describa la imagen')
          .col-lg-9
