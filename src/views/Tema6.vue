  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-11.col-md-10.col-10
        p.mb-4 <b>Política de Atención Integral en Salud — PAIS</b>
    ...
    .row.mb-5
      .col-lg-12.col-md-12.col-12
        .tarjeta.colorgris.p-5
          .row 
            .col-lg-12
              h4 Artículos que componen la Resolución 0429 de 2016 - Ministerio de Salud. “Por medio de la cual se adopta la Política de Atención Integral en Salud”
    ...
    .row.mb-4 
      .col-lg-12
        .tarjeta.colorgris.p-5
          h5 Resolución 2626 de 2019
          p La presente resolución tiene por objeto modificar la Política de Atención Integral de Salud -PAIS y adoptar el Modelo de Acción Integral Territorial MAITE para su implementación.
    ...
    p.mb-4 <b>Realizar la lectura de Resolución 2626 de 2019- Ministerio de Salud. “Por la cual se modifica la Política de Atención Integral en Salud -PAIS y se adopta el Modelo de Acción Integral Territorial-MAITE” donde encontraras temas de suma importancia como:</b>
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-7.col-md-12.col-12
